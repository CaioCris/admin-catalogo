...
class CategoryTest {
    ...
    public void givenAnInValidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReturnError() {
        final String expectedName = """
                Não obstante, a percepção das dificuldades deve passar por modificações independentemente das direções
                preferenciais no sentido do progresso. Por outro lado, o início da atividade geral de formação de
                atitudes não pode mais se dissociar das diretrizes de desenvolvimento para o futuro.
                Assim mesmo, a adoção de políticas descentralizadoras facilita a criação dos métodos utilizados na
                avaliação de resultados. No entanto, não podemos esquecer que a estrutura atual da organização aponta
                para a melhoria das diversas correntes de pensamento. Podemos já vislumbrar o modo pelo qual
                o comprometimento entre as equipes representa uma abertura para a melhoria das novas proposições.
                """;
        final var expectedErrorCount = 1;
        final var expectedErrorMessage = "'name' must be between 3 and 255 characters";
        final var expectedDescription = "A categoria mais assistida";
